...
var _ScrollbarSize = _interopRequireDefault(require("../../../node_modules/@material-ui/core/Tabs/ScrollbarSize"));
...
var _TabScrollButton = _interopRequireDefault(require("../../../node_modules/@material-ui/core/Tabs/TabScrollButton"));
    ...
    value: function render() {
      ...
      var children = _react.default.Children.map(childrenProp, function (child) {
        ...
        return _react.default.cloneElement(child, {
          ...
          textColor: textColor,
          value: childValue,
          indicatorStyle: _this2.state.indicatorStyle
        });
      });
      ...
      }, children), this.state.mounted), conditionalElements.scrollButtonRight));
    }
  }]);
  return Tabs;
